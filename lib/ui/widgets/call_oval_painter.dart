...
paint_1_fill.shader = ui.Gradient.linear(Offset(size.width*0.8000000,size.height*0.4778481), Offset(size.width*0.8000000,size.height*0.5917722), [Color(0xff57C389).withOpacity(1),Color(0xff78DE7B).withOpacity(1),Color(0xff8BE26D).withOpacity(1)], [0,0.421875,1]);
