...
import 'package:bisa_app/ui/home/covid_page.dart';
...
// onclick help animate color change
// onclick tips category animate size and color change

class Home extends StatefulWidget {
  Home({Key? key}) : super(key: key);
  // final GlobalKey<State<StatefulWidget>> one;
  // final GlobalKey<State<StatefulWidget>> two;
  // final GlobalKey<State<StatefulWidget>> three;
...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin{
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //           fontSize: 18.sp,
                      //           color: Color.fromRGBO(99, 93, 93, 0.98)
                      //         ),
                      //       ),
                      //     ),
                      //   ],
                      // ),),
                      // // today's appointment
                      // FadeAnimation(1.2,0,-30,Padding(
                      //   padding: const EdgeInsets.all(8.0),
                      //   child: Showcase(
                      //     key: widget.one,
                      //     overlayPadding: EdgeInsets.only(left:-30.0,right: 30),
                      ...
                      //               children: [
                      //                 Text('${DateFormatter().getWeekDay(now.weekday)}',
                      //                   style: TextStyle(
                      //                     fontFamily: 'Poppins',
                      //                     fontWeight: FontWeight.w600,
                      //                     fontSize: 15.sp,
                      //                     color: Color.fromRGBO(155, 204, 219, 1)
                      //                   ),
                      //                 ),
                          ...
                          child: Container(
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...
                                //     // Navigator.push(
                                //     //   context,
                                //     //   PageAnimationTransition(type:PageAnimationTransitionType.fade,child: PlansScreen() ));
                                //   },
                                //   child: Container(
                                ...
                                //       mainAxisAlignment: MainAxisAlignment.center,
                                //       children: [
                                //         Image.asset('assets/imgs/safe2.png',height: 40.h,fit: BoxFit.cover),
                                //         SizedBox(height: 15,),
                                //         Text('INSURANCE',
                                //           style: TextStyle(
                                //             fontFamily: 'Poppins',
                                //             fontWeight: FontWeight.w600,
                                //             fontSize: 14.sp,
                                //             color: Color.fromRGBO(92, 94, 86, 1)
                                //           ),
                                //         )
                                //       ],
                                //     ),
                                ...
                                //     mainAxisAlignment: MainAxisAlignment.center,
                                //     children: [
                                //       Image.asset('assets/imgs/chat1.png',height: 40.h,fit: BoxFit.cover),
                                //       SizedBox(height: 15.h,),
                                //       Text(' OPEN\nFORUM',
                                //         style: TextStyle(
                                //           fontFamily: 'Poppins',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //searchbox
                        // FadeAnimation(1.4,0,30,Container(
                        ...
                        //     child: Row(
                        //       children: [
                        //         Icon(CupertinoIcons.search,color: Color.fromRGBO(123, 115, 115, 1),),
                        //         SizedBox(width: 10.w,),
                        //         Text('Search for specialist or health issue',
                        //           style: TextStyle(
                        //             fontFamily: 'Lato',
                        //             fontWeight: FontWeight.w400,
                        //             fontSize: 14.sp,
                        //             color: Color.fromRGBO(167, 158, 158, 1)
                        //           ),
                        //         )
                        //       ],
                        //     ),
              ...
              Positioned(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    child: CustomPaint(
                      size: Size(120.w, (120.w*2.8727272727272726).toDouble()),
  ...
  FadeAnimation buildArticleList(int index) {
    return FadeAnimation(
      ...
      FutureBuilder(
        future: getArticles(
            {'id': index, 'token': currentUser.token}
          ),
        builder: (context, AsyncSnapshot snapshot) {
          if (!snapshot.hasData) {
            return Center(child: CircularProgressIndicator.adaptive());
          } else if (snapshot.hasError) {
            return Center(child: Text('Sorry, unable to load articles'));
          } else {
            ...
            return Column(
              ...
              var day = DateFormat('EEEE')
                  ...
                  .substring(0, 3);
              var num = DateFormat('d')
                  .format(DateTime.parse(e['created_at']));

              var desc = e['intro'] == null? "This is an awesome article to read. Check it out." : e['intro'];
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    launch('tel:0308249010');
                  },
                  child: Container(
                    height: 40.h,
                    width: 100.w,
                    decoration: BoxDecoration(
                      color: Color.fromRGBO(142, 211, 55, 1),
