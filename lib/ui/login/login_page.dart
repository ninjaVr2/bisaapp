      ...
      if (loggedinUser.toString().isNotEmpty) {
        ...
        Navigator.push(
            ...
            PageAnimationTransition(
                pageAnimationType: TopToBottomTransition(), page: HomePage(),),);
        // });
      } else {
        // await Future.delayed(Duration(seconds: 4), () {
        // Navigator.pop(context);
...
class Login extends StatefulWidget {
  Login({Key? key, required this.coastController}) : super(key: key);
                            ...
                            InkWell(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    ...
                                    color: Color.fromRGBO(151, 197, 134, 1)),
                              ),
                            )
                          ],
                        ),
...
class ResetPassword extends StatefulWidget {
  ResetPassword({Key? key, required this.coastController}) : super(key: key);
                ...
                builder: (BuildContext context) {
                  return MultiPopup(
                    onTap: () {
                      Navigator.pop(context);
                      widget.coastController.animateTo(
                          beach: 0, duration: Duration(milliseconds: 1200));
                    },
