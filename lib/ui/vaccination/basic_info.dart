          ...
          child: Column(
            children: [
              ExpansionPanelList(
                ...
                expandedHeaderPadding: EdgeInsets.only(bottom: 1),
              ...
              SizedBox(height: 22,),
              Text("Remember, Ghana needs you. Stop the  spread, get vaccinated against COVID-19  for additional protection.",
              ...
              SizedBox(height: 18,),
              Text("Designed and produced by Health Promotion Division Ghana Health Service",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontFamily: 'Lato',
