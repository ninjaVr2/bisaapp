...
class TestingCenters extends StatefulWidget {
  TestingCenters({Key? key,required this.centers}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Sort By:',
                style: TextStyle(
                  color: Color.fromRGBO(40, 56, 102, 1),
                  fontFamily: 'Lato',
              ...
              CupertinoSlidingSegmentedControl<int>(
                backgroundColor:  Color.fromRGBO(207, 237, 245, 0.44),
                    ...
                    child: Center(
                      child: Text('Name',
                        style: TextStyle(
                          ...
                          color: Color.fromRGBO(33, 72, 107, 1)
                        ),
                      )
                    ),
                  ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15.sp,
                                          color: Color.fromRGBO(155, 156, 159, 1)
                                        ),
                                      ),
                                    ),
                                  ),
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          height: 36.h,
                                          decoration: BoxDecoration(
                                            color: Color.fromRGBO(0, 44, 85, 0.87),
                                            borderRadius: BorderRadius.circular(5),
                                            boxShadow: [
                                              BoxShadow(
                                                offset: Offset(0,5),
