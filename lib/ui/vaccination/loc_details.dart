...
class LocDetails extends StatefulWidget {
  LocDetails({Key? key, required this.centers, required this.name}) : super(key: key);
  final  List<Centerlist> centers;
  final String name;

  @override
  _LocDetailsState createState() => _LocDetailsState();
}

class _LocDetailsState extends State<LocDetails> {
  @override
